<?php
    ...
    if (isset($_POST['signin'])){
        ...
        setcookie("SIGNEDIN", $signedCookie, time()+5600, '/');
        setcookie("USERID", $signedIDCookie, time()+5600, '/');
    }
    //Signup to account
                ...
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <div class="icon-footer-social mb-5"><a href="#!" class="icon-footer-social-link"><svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" role="img"
                                ...
                                </svg></a><a href="#!" class="icon-footer-social-link"><svg aria-hidden="true" focusable="false"
